        ...
        foreach ($results as $result): ?>
            ...
            <?php else: ?>
                ...
                <div class="colorBlock">
                    <a href="index.php?color=<?php echo htmlspecialchars($result['color1']); ?>" style="background-color:<?php echo $result['color1'] ?>;" class="colorBtn"><p><?php echo $result['color1'] ?></p></a>
                    <a href="index.php?color=<?php echo htmlspecialchars($result['color2']); ?>" style="background-color:<?php echo $result['color2'] ?>;" class="colorBtn"><p><?php echo $result['color2'] ?></p></a>
                    <a href="index.php?color=<?php echo htmlspecialchars($result['color3']); ?>" style="background-color:<?php echo $result['color3'] ?>;" class="colorBtn"><p><?php echo $result['color3'] ?></p></a>
                    <a href="index.php?color=<?php echo htmlspecialchars($result['color4']); ?>" style="background-color:<?php echo $result['color4'] ?>;" class="colorBtn"><p><?php echo $result['color4'] ?></p></a>
                </div>
                <div>
